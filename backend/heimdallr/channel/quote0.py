...
class Quote0(Channel):
    ...
    def _build_channel(self, config: dict) -> None:
        ...
        """
        self.base_url = config.get(SUFFIX_QUOTE0_BASE_URL, self.base_url)
        self.device_id = config.get(SUFFIX_QUOTE0_DEVICE_ID, "")
        self.api_key = config.get(SUFFIX_QUOTE0_API_KEY, "")
